...
export const Header = () => {
  return <header className="w-full bg-foreground py-4">
      <div className="container mx-auto px-4">
        <div className="flex items-center gap-2">
          <Sparkles className="text-primary" size={24} />
          <span className="text-xl font-black text-card uppercase tracking-tight">NATALIA'S  TRAVEL GUIDE</span>
        </div>
      </div>
    </header>;
};
      ...
      <div className="container mx-auto px-4">
        ...
        duration: 0.5
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <span className="feature-badge">
              <span>✓</span>
              <span>AI Travel Chat (Coming soon)</span>
            </span>
          </div>
        </motion.div>
      </div>
